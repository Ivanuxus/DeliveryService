...
const columns = [
    ...
    { title: 'Email', dataIndex: 'email', key: 'email' }, // Добавляем email
];
    ...
    return (
        <Container>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 2 }}>
                <Typography variant="h1" gutterBottom>Курьеры</Typography>
                <Typography variant="body1">                        
                Дабы с заказами не возникало проблем и для удобства всех "значимых" звеньев цепи - в каждого курьера вживлён чип.Ни один курьер не пострадал...
                </Typography>
